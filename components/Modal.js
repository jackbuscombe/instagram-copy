    ...
    <Transition.Root show={open} as={Fragment}>
      ...
      >
        <div className="flex min-h-[800px] items-end justify-center px-4 pt-4 pb-20 text-center sm:block sm:min-h-screen sm:p-0">
          ...
          >
            <div className="relative inline-block transform overflow-hidden rounded-lg bg-white p-4 text-left align-bottom shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg sm:align-middle">
              <div>
                {selectedFile ? (
                  <img
                    src={selectedFile}
                    ...
                    className="max-h-44 w-full cursor-pointer object-contain"
                  />
                ) : (
                  <div
                ...
                <div className="mt-3 text-center sm:ml-5">
                  <Dialog.Title
                    as="h3"
